...
export default function NavigationSidebar() {
  ...
  return (
    <div className="sidebar">
      <div>
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center gap-2">
            <div className="flex items-center justify-center w-7 h-7 rounded" style={{ background: 'var(--accent)', color: '#fff' }}>
          ...
          <button onClick={toggleTheme} className="theme-toggle" aria-label={theme === 'dark' ? 'Modo claro' : 'Modo oscuro'}>
      ...
      <div style={{ borderTop: '1px solid var(--border-card)' }} className="pt-4 flex flex-col gap-2">
